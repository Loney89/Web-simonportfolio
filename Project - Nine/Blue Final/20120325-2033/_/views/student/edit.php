...
////
** Query to get student Details, and login.
**
**
////
...
<?php
class editdetails extends base {
$result = mysql_query("select * from student INNER JOIN user ON user.user_id=student.user_id WHERE user.user_name='drbuckland@hotmail.co.uk'");
$numRows = mysql_num_rows($result);
if($numRows >0){
 while($row = mysql_fetch_array($result))
 {
    echo $row['Name'] . " " . $row['Start'] . " " . $row['End'] . " " . $row['Status'];
    echo "<br />";   
  } 
}
}
...
<div id="content" class="container_12">
  <div class="details_form">
    <form action="#" method="post">
      <fieldset>
       <?php echo $usertype.' - '.$_SESSION['email'];?>
        <ol>
          <li>
