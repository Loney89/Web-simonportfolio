...
var YrSelColor = "#333"; //color of font of Year selector.
var MthSelColor = "#333"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#E0FF38"; //color when mouse move over.
var DisableColor = "#333"; //color of disabled cell.
...
function Calendar(pDate, pCtrl)
{
	...
	if (pDate.getMinutes() < 15)
	{
		this.Minutes = "00";
	}
	else if (pDate.getMinutes() < 30)
	{
		this.Minutes = "30";
	}
	else if (pDate.getMinutes() < 45)
	{
		this.Minutes = "45";
	}
	else
...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.ShowTime === true)
	{
		...
		vCalTime += "<tr><td colspan='4' style=\"text-align:center;\"><input style='width:100px;font-size:12px;' onClick='javascript:closewin(\"" + Cal.Ctrl + "\");'  type=\"button\" value=\"OK\"></td><td colspan='4' style=\"text-align:center;\"><input style='width:100px;font-size:12px;' onClick='javascript: winCal.style.visibility = \"hidden\"' type=\"button\" value=\"Cancel\"></td></tr>";
	}
...
function nextStep(whatSpinner, direction)
{
	...
	else if (whatSpinner === "Minute")
	{
		if (direction === "plus")
		{
			Cal.SetMinute(parseInt(Cal.Minutes, 10) + 15); //CHANGED
			RenderCssCal();
		}
		else if (direction === "minus")
		{
